...
from preprocess import LineByLineTextDataset,TextDataset


from data_collator import DataCollatorForLanguageModeling
from  hf_argparser import HfArgumentParser
from trainer import Trainer,TrainingArguments,set_seed
...
def get_dataset(args: DataTrainingArguments, tokenizer: BertTokenizer, evaluate=False, local_rank=-1):
    file_path = args.eval_data_file if evaluate else args.train_data_file
    if args.line_by_line:
        return LineByLineTextDataset(
            tokenizer=tokenizer, file_path=file_path, block_size=args.block_size, local_rank=local_rank, doc_stride = args.doc_stride
        )
    else:
        return TextDataset(
